// Joplin SDK — umbrella runtime header (template; Joplin tokens
...
typedef struct JoplinSDK JoplinSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs JoplinError)
// ===========================================================================
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + JoplinEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (JoplinEntity). On error set *err and return NULL.
...
// ===========================================================================
// SDK client (mirrors Main.fragment JoplinSDK) — generic fields.
// ===========================================================================
...
void sdk_features_push(JoplinSDK* sdk, Feature* f);
void sdk_features_insert(JoplinSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(JoplinSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(JoplinSDK* sdk); // deep clone of options
Utility* sdk_get_utility(JoplinSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(JoplinSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
JoplinSDK* projectname_sdk_new(voxgig_value* options);
JoplinSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(JoplinSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(JoplinSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_graphql(JoplinSDK* sdk, const char* query,
