...
// Joplin SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = JoplinOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(JoplinOmni::structfix($now, Struct::undef()))
                        !== json_encode(JoplinOmni::structfix($val, Struct::undef()))) {
