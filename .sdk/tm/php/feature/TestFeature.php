...
// Joplin SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class JoplinTestFeature extends JoplinBaseFeature
{
    ...
    public function init(JoplinContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (JoplinContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (JoplinContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(JoplinContext $ctx, $op, $args): array
    {
