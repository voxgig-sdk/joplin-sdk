...
from projectname_sdk import JoplinSDK
from projectname_sdk.core.spec import JoplinSpec
from projectname_sdk.core.result import JoplinResult
from projectname_sdk.core.operation import JoplinOperation
from projectname_sdk.core.error import JoplinError
from projectname_sdk.feature.base_feature import JoplinBaseFeature
...
_runner = makeRunner(TEST_JSON_FILE, JoplinSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = JoplinSDK.test(None, None)
        utility = client._utility
    ...
    def test_feature_init_basic(self):
        init_client = JoplinSDK.test(None, None)
        ...
        class TestInitFeature(JoplinBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(JoplinBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = JoplinSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = JoplinSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = JoplinSDK.test(None, setup.get('a') or {})
