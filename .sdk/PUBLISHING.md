...
|---|---|---|
| `ts/` | @voxgig-sdk/joplin | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/joplin \
      --repository voxgig-sdk/joplin-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/joplin` shows it, and
`npm trust revoke @voxgig-sdk/joplin --id=<id>` removes it.
