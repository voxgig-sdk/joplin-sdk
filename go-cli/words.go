...
func registerSDKWords(r *eng.Registry, client *sdk.JoplinSDK) {
...
func runOp(client *sdk.JoplinSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
