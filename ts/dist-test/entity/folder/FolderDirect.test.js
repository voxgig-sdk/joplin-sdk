...
function liveScenariosActive() { return false && process.env.JOPLIN_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.JoplinSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.JOPLIN_APIKEY,
        }));
        let idmap = env['JOPLIN_TEST_FOLDER_ENTID'];
    ...
    const client = new __1.JoplinSDK({
        base: 'http://localhost:8080',
