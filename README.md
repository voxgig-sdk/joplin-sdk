...
Full documentation for this SDK: [https://voxgig-sdk.github.io/joplin-sdk/](https://voxgig-sdk.github.io/joplin-sdk/)
...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
| Python | `voxgig-sdk-joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
| PHP | `voxgig-sdk/joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
| Golang | `github.com/voxgig-sdk/joplin-sdk/go` | `go get github.com/voxgig-sdk/joplin-sdk/go@latest` |
| Ruby | `voxgig-sdk-joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
| Lua | `voxgig-sdk-joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
| C | `voxgig-sdk-joplin` | publish pending — [install from git tag](https://github.com/voxgig-sdk/joplin-sdk/tags) |
...
// List all folders (returns a List, sets *err on failure)
voxgig_value* folders = folder->vt->list(folder, NULL, NULL, &err);
for (size_t i = 0; i < (size_t)voxgig_size(folders); i++) {
    printf("%s\n", voxgig_to_json(voxgig_getelem(folders, v_int(i), NULL)));
}

// Load a specific folder (returns the record, sets *err on failure)
