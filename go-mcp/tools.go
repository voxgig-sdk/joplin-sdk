...
type Args struct {
	Entity string         `json:"entity" jsonschema:"folder | note | tag"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.JoplinSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "joplin_list",
		Description: "List records from Joplin. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "joplin_load",
		Description: "Load a single record from Joplin. " +
...
func runOp(client *sdk.JoplinSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.JoplinSDK, name string) (sdk.JoplinEntity, error) {
