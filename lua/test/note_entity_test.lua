...
describe("NoteEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set JOPLIN_TEST_NOTE_ENTID JSON to run live")
      return
    end
    ...
    local note_ref01_markdef_up0_name = "author"
...
function note_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("JOPLIN_TEST_NOTE_ENTID")
