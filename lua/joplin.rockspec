...
source = {
  ...
  url = "git+https://github.com/voxgig-sdk/joplin-sdk.git",
  tag = "lua/v0.0.1",
  dir = "joplin-sdk/lua"
}
description = {
  summary = "Unofficial generated Lua SDK for the Joplin Data public API. Not affiliated with or endorsed by the upstream API provider.",
  homepage = "https://github.com/voxgig-sdk/joplin-sdk",
  issues_url = "https://github.com/voxgig-sdk/joplin-sdk/issues",
  license = "MIT",
  labels = { "voxgig", "sdk", "generated-sdk", "openapi", "api-client", "joplin" }
}
dependencies = {
  "lua >= 5.3",
  "dkjson >= 2.5",
