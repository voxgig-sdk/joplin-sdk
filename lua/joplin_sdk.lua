...
JoplinSDK._make_feature = _make_feature


function JoplinSDK.new(options)
  local self = setmetatable({}, JoplinSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function JoplinSDK:options_map()
...
function JoplinSDK:get_utility()
  return Utility.copy(self._utility)
end


function JoplinSDK:get_root_ctx()
  return self._rootctx
end


function JoplinSDK:prepare(fetchargs)
...
function JoplinSDK:direct(fetchargs)
...
-- by passing it.
function JoplinSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function JoplinSDK:graphql(query, variables, ctrl)
...
function JoplinSDK:Folder(data)
...
function JoplinSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = JoplinSDK.new(sdkopts)
  sdk.mode = "test"
