...
// Joplin SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (JoplinSDK::test)
...
{
    private const SDK_CLASS = 'JoplinSDK';
    ...
    private const SDK_BASE = 'joplin_sdk';
