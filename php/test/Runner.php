...
class JoplinTestRunner
{
    ...
    {
        $live = self::getenv('JOPLIN_TEST_LIVE');
        $override = self::getenv('JOPLIN_TEST_OVERRIDE');
        ...
        $explain = self::getenv('JOPLIN_TEST_EXPLAIN');
...
class_alias('JoplinTestRunner', 'Runner');
class_alias('JoplinHelpers', 'Helpers');
