...
class JoplinTimeoutFeature extends JoplinBaseFeature
{
    ...
    private function _with_timeout(JoplinContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(JoplinContext $_ctx, float $ms): void
    {
        $client = $this->client;
