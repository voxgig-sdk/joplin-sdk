...
class JoplinPagingFeature extends JoplinBaseFeature
{
    ...
    private function _graphql_pre_request(JoplinContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(JoplinContext $ctx): bool
    {
