...
class JoplinRatelimitFeature extends JoplinBaseFeature
{
    ...
    private function _acquire(JoplinContext $ctx): void
    {
    ...
    private function _track(JoplinContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
