...
class JoplinFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; JoplinSDK/1.0)';
    ...
    public static function call(JoplinContext $ctx, string $fullurl, array $fetchdef): array
    {
