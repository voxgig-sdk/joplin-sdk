...
func NewTagEntity(client *core.JoplinSDK, entopts map[string]any) *TagEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TagEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// TagUpdateData and returns an Tag. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *TagEntity) UpdateTyped(reqdata TagUpdateData, ctrl map[string]any) (Tag, error) {
