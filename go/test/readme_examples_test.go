...
const testSeed = `map[string]any{"entity": map[string]any{"folder": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "note": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
