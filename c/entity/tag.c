// Tag entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*tag_postdone_fn)(tag_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT tag_VT;
static const char* tag_get_name(Entity* e);
static Entity* tag_make(Entity* e);
static voxgig_value* tag_data(Entity* e, voxgig_value* args);
static voxgig_value* tag_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* tag_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** tag_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* tag_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* tag_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* tag_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void tag_mark_deleted(Entity* e);
static bool tag_deleted(Entity* e);

static Context* tag_ent_ctx(tag_entity* self) {
  return self->entctx;
}
...
Entity* tag_entity_new(JoplinSDK* client, voxgig_value* entopts) {
  ...
  tag_entity* self = (tag_entity*)calloc(1, sizeof(tag_entity));
  self->base.vt = &tag_VT;
  self->name = strdup("tag");
  self->client = client;
...
static voxgig_value* tag_run_op(tag_entity* self, Context* ctx,
                                    tag_postdone_fn post_done, PNError** err) {
...
voxgig_value* tag_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  tag_entity* self = (tag_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
...
static Entity* tag_make(Entity* e) {
  ...
  return tag_entity_new(self->client, opts);
}
...
static voxgig_value* tag_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tag_ent_ctx(self), "SetData");
  }
  feature_hook_util(tag_ent_ctx(self), "GetData");
...
static voxgig_value* tag_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(tag_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(tag_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void tag_load_postdone(tag_entity* self, Context* ctx) {
...
static Entity* tag_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
  tag_run_op(self, ctx, tag_load_postdone, err);
  if (*err) return NULL;
...
static void tag_list_postdone(tag_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** tag_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
  voxgig_value* out = tag_run_op(self, ctx, tag_list_postdone, err);
  if (*err) return NULL;
...
static void tag_create_postdone(tag_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* tag_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
  tag_run_op(self, ctx, tag_create_postdone, err);
  if (*err) return NULL;
...
static void tag_update_postdone(tag_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* tag_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
  tag_run_op(self, ctx, tag_update_postdone, err);
  if (*err) return NULL;
...
static void tag_remove_postdone(tag_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* tag_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, tag_ent_ctx(self));
  tag_run_op(self, ctx, tag_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void tag_mark_deleted(Entity* e) {
  ((tag_entity*)e)->deleted = true;
}

static bool tag_deleted(Entity* e) {
  return ((tag_entity*)e)->deleted;
}
