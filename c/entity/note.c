// Note entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*note_postdone_fn)(note_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT note_VT;
static const char* note_get_name(Entity* e);
static Entity* note_make(Entity* e);
static voxgig_value* note_data(Entity* e, voxgig_value* args);
static voxgig_value* note_matchv(Entity* e, voxgig_value* args);
// Ops resolve to the ENTITY (`list` to a NULL-terminated array of them).
static Entity* note_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity** note_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static Entity* note_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* note_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static Entity* note_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static void note_mark_deleted(Entity* e);
static bool note_deleted(Entity* e);

static Context* note_ent_ctx(note_entity* self) {
  return self->entctx;
}
...
Entity* note_entity_new(JoplinSDK* client, voxgig_value* entopts) {
  ...
  note_entity* self = (note_entity*)calloc(1, sizeof(note_entity));
  self->base.vt = &note_VT;
  self->name = strdup("note");
  self->client = client;
...
static voxgig_value* note_run_op(note_entity* self, Context* ctx,
                                    note_postdone_fn post_done, PNError** err) {
...
voxgig_value* note_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  note_entity* self = (note_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
...
static Entity* note_make(Entity* e) {
  ...
  return note_entity_new(self->client, opts);
}
...
static voxgig_value* note_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(note_ent_ctx(self), "SetData");
  }
  feature_hook_util(note_ent_ctx(self), "GetData");
...
static voxgig_value* note_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(note_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(note_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void note_load_postdone(note_entity* self, Context* ctx) {
...
static Entity* note_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
  note_run_op(self, ctx, note_load_postdone, err);
  if (*err) return NULL;
...
static void note_list_postdone(note_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static Entity** note_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
  voxgig_value* out = note_run_op(self, ctx, note_list_postdone, err);
  if (*err) return NULL;
...
static void note_create_postdone(note_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static Entity* note_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
  note_run_op(self, ctx, note_create_postdone, err);
  if (*err) return NULL;
...
static void note_update_postdone(note_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* note_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
  note_run_op(self, ctx, note_update_postdone, err);
  if (*err) return NULL;
...
static void note_remove_postdone(note_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static Entity* note_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, note_ent_ctx(self));
  note_run_op(self, ctx, note_remove_postdone, err);
  if (*err) return NULL;
...
// live record.
static void note_mark_deleted(Entity* e) {
  ((note_entity*)e)->deleted = true;
}

static bool note_deleted(Entity* e) {
  return ((note_entity*)e)->deleted;
}
