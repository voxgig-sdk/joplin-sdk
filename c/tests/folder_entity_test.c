// Generated instance test for the folder entity.

#include "ctest.h"

int main(void) {
  JoplinSDK* sdk = test_sdk(NULL, NULL);
  CHECK(sdk != NULL, "sdk constructed");

  Entity* e = joplin_folder(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "folder", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    JoplinSDK* strsdk = test_sdk(seed, sdkopts);
    Entity* se = joplin_folder(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = folder_stream(se, "list", NULL, NULL, &serr);
    ...
    JoplinSDK* plainsdk = test_sdk(seed, NULL);
    Entity* pe = joplin_folder(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = folder_stream(pe, "list", NULL, NULL, &perr);
