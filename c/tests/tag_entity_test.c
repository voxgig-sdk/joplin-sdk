// Generated instance test for the tag entity.
...
int main(void) {
  ...
  Entity* e = joplin_tag(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "tag", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = joplin_tag(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = tag_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = joplin_tag(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = tag_stream(pe, "list", NULL, NULL, &perr);
