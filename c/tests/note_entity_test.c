// Generated instance test for the note entity.
...
int main(void) {
  ...
  Entity* e = joplin_note(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "note", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = joplin_note(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = note_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = joplin_note(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = note_stream(pe, "list", NULL, NULL, &perr);
