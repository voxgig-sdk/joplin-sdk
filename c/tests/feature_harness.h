// Behavioural feature-test harness for the Joplin SDK (C port of the
...
#ifndef JOPLIN_FEATURE_HARNESS_H
#define JOPLIN_FEATURE_HARNESS_H
...
#endif // JOPLIN_FEATURE_HARNESS_H
