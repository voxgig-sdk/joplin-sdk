...
// ---- SDK client-base generic helpers (Main.fragment JoplinSDK) -------
...
voxgig_value* sdk_options_map(JoplinSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(JoplinSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(JoplinSDK* sdk) { return sdk->rootctx; }
