...
module JoplinTestRunner
  ...
  def self.env_override(m)
    live = getenv("JOPLIN_TEST_LIVE")
    override = getenv("JOPLIN_TEST_OVERRIDE")
    ...
    explain = getenv("JOPLIN_TEST_EXPLAIN")
    m["JOPLIN_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = JoplinTestRunner
Helpers = JoplinHelpers
Vs = VoxgigStruct
