...
class NoteEntity
  ...
  # @return [Note, Hash] the current Note data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Note fields)
  def match_get
  ...
  # Load a single Note.
  #
  # @param reqmatch [NoteLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Note.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Note, Hash] the loaded Note; raises JoplinError on failure
  ...
  #
  # @param reqmatch [NoteListMatch, Hash, nil] match filter (any subset of
  #   Note fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Note>, Array] the matching Note items; raises JoplinError on failure
  ...
  # Create a new Note.
  #
  # @param reqdata [NoteCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Note, Hash] the created Note; raises JoplinError on failure
  ...
  #
  # @param reqdata [NoteUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Note, Hash] the updated Note; raises JoplinError on failure
  ...
  #
  # @param reqmatch [NoteRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Note, Hash] the removed Note; raises JoplinError on failure
