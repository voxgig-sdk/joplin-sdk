# Joplin SDK feature test harness
#
...
from joplin_sdk.features import _make_feature
...
class _Ctx:
    ...
    def __init__(self, client, utility, op=None, entity=None, ctrl=None):
        ...
        self.out = {}
        self.ctrl = ctrl if ctrl is not None else JoplinControl()
        self.meta = {}
        self.op = op
        self.entity = entity
