# Joplin SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions JoplinSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both JoplinSDK(...) and JoplinSDK.test(...) become
#      JoplinSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "joplin_sdk"
_SDK_CLASS = "JoplinSDK"
