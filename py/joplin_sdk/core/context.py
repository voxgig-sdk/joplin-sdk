...
from joplin_sdk.core.control import JoplinControl
...
from joplin_sdk.core.helpers import get_ctx_prop, to_map
...
class JoplinContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, JoplinResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return JoplinError(code, msg, self)
