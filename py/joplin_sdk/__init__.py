...
from joplin_sdk.utility import register

# Load features
from joplin_sdk.feature.base_feature import JoplinBaseFeature
from joplin_sdk.features import _has_feature, _make_feature
...
class JoplinSDK:
    ...
    def get_utility(self):
        return JoplinUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("JoplinSDK: graphql: " + str(msg))
            res["graphql"] = errors
